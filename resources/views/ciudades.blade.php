                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <tbody>
                                            <!-- Aquí es donde debes hacer un bucle sobre las ciudades desde el controlador -->
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                            <button type="button" class="btn btn-sm btn-primary"
                                                                ...
                                                                data-bs-target="#editar-{{ $ciudad->id }}">
                                                                <i class="bi bi-pencil-square"></i>
                                                            </button>

                                                            <!-- Modal de edición -->
                                                            <div class="modal fade" id="editar-{{ $ciudad->id }}"
                                                                tabindex="-1">
                                                                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('ciudades.update', $ciudad->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('PUT')
                                                            ...
                                                            <form action="{{ route('ciudades.destroy', $ciudad->id) }}"
                                                                method="POST" id="deleteForm-{{ $ciudad->id }}">
                                                                @csrf
                                                                @method('DELETE')
