...
<button id="resetPassword{{ $value }}" data-user-id="{{ $value }}" data-action="resetPassword"
    class="bg-transparent border-0" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $mensaje }}">
    <!-- Aquí puedes colocar el ícono de restablecer contraseña -->
