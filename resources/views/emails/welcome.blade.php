...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Estamos emocionados de que te unas a nuestra plataforma. A continuación, encontrarás tus credenciales de
                inicio de sesión:</p>
            <div class="credentials-box">
                <p><strong>Email:</strong> {{ $usuario->email }}</p>
                <p><strong>Contraseña:</strong> {{ $password }}</p>
            </div>
            <p>Por favor, inicia sesión y cambia tu contraseña después de iniciar sesión por primera vez para garantizar
                la seguridad de tu cuenta.</p>
        </div>
        <div class="footer">
